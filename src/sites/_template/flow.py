"""
Navigation flow for template site.

This file contains navigation-only logic. No data extraction
or normalization should be performed here - keep it focused
on page interactions and navigation.
"""

from src.sites.base.flow import BaseFlow


class TemplateFlow(BaseFlow):
    """Navigation flow for template site."""
