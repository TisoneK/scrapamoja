    ...
    def _structured_match_to_dict(self, structured_match: StructuredMatch) -> dict:
        ...
        return {
            ...
            'basic_info': {
                ...
                'competition': structured_match.basic_info.competition,
                'league': structured_match.basic_info.league,
            },
            ...
            'lineups_tab': self._tab_data_to_dict(structured_match.lineups_tab),
            'standings_tab': self._tab_data_to_dict(structured_match.standings_tab),
            'extraction_metadata': {
