@echo off
rem context-collab-check.cmd -- policy-free launcher for context-collab-check.ps1 (Windows).
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0context-collab-check.ps1" %*
exit /b %ERRORLEVEL%
