...
- **Gates:** `.context/memory/workflows/gates.conf` — checkpoint before each next action; `pre-commit`, `integration`, and `exit` gates are mandatory (core 0.8.0 initialized the gates 2026-08-18; core 0.17.0 in force since 2026-09-08 — universal roster check-in; Windows agents use the `.cmd` launchers)
