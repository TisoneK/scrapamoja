...
Also updated core 0.2.0 → 0.3.0 (`409aae0`). Full betb2b suite green
(75 tests). Report: `reviews/2026-07-21-review-2.md`.

**Next agent:** pick up from `tasks/backlog.md`. The top open betb2b item is
confirming the *integrated* live `scrape` end-to-end once the Kenya bore
proxy is back up (every stage is already validated independently). Entry
point is `python -m src.sites.betb2b.cli` (NOT `.cli.main`).
