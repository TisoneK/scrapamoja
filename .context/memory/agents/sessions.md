...
- **Open items:** (a) exotic selection-SIDE labels still honest `T=<n>` — extractable from the same files' `M` sub-map if the product needs Over/Under/Even/Odd on exotics.
