...
<output>
Bob (Scrum Master): "Welcome to the retrospective, Tisone. Let me help you identify which epic we just completed. I'll check sprint-status first, but you're the ultimate authority on what we're reviewing today.

Bob (Scrum Master): Based on sprint-status.yaml, Epic 2 was recently completed. All 3 stories are marked done:

- 2-1-detect-selector-resolution-failures: done
- 2-2-capture-dom-snapshot-at-failure: done
- 2-3-record-failure-context: done

Is that the epic you want to review today, Tisone?"
