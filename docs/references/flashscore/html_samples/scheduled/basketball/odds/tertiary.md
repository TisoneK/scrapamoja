# Scheduled Basketball - Odds Tab - Tertiary Tabs
...
<!-- These are sub-tabs within each odds market type -->
...
- Typical tertiary options include time periods (FT including OT, 1st Half, etc.)
...
- **Live:** Some time period options may not be available as match progresses
