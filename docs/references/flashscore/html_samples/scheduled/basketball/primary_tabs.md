# Scheduled Basketball Match - Primary Tabs
...
This HTML sample captures the **primary navigation tabs** for a scheduled basketball match on Flashscore. The match is in a "scheduled" state (not yet started), which affects the available secondary tabs.

### Tab Structure

| Tab | data-analytics-alias | URL Path | Active |
|-----|---------------------|----------|--------|
| Summary | `match-summary` | `/match/basketball/.../?mid=Q1pAmBdc` | Yes |
| Odds | `odds-comparison` | `/match/basketball/.../odds/?mid=Q1pAmBdc` | No |
| H2H | `h2h` | `/match/basketball/.../h2h/?mid=Q1pAmBdc` | No |
| Standings | `stats-detail` | `/match/basketball/.../standings/?mid=Q1pAmBdc` | No |
...
<div class="detailOver">
  <div data-testid="wcl-tabs" 
    ...
    <a data-analytics-element="SCN_TAB" 
       ...
       class="" 
       href="/match/basketball/derthona-tortona-0OZBANVT/sassari-CQMh2ve4/odds/?mid=Q1pAmBdc" 
       data-discover="true">
      <button data-testid="wcl-tab" 
              data-selected="false" 
              class="wcl-tab_GS7ig" 
    ...
    <a data-analytics-element="SCN_TAB" 
       ...
       class="" 
       href="/match/basketball/derthona-tortona-0OZBANVT/sassari-CQMh2ve4/h2h/?mid=Q1pAmBdc" 
       data-discover="true">
      <button data-testid="wcl-tab" 
              data-selected="false" 
              class="wcl-tab_GS7ig" 
    ...
    <a data-analytics-element="SCN_TAB" 
       ...
       class="" 
       href="/match/basketball/derthona-tortona-0OZBANVT/sassari-CQMh2ve4/standings/?mid=Q1pAmBdc" 
       data-discover="true">
      <button data-testid="wcl-tab" 
              data-selected="false" 
              class="wcl-tab_GS7ig" 
...
- **Live:** Additional tabs may appear (Player Stats, Match Stats, Lineups)
